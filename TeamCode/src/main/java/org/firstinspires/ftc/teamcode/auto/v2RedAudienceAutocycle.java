...
public class v2RedAudienceAutocycle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory placePurple2 = drive.trajectoryBuilder(startPose, true)
                .lineToLinearHeading(new Pose2d(-36, -32, Math.toRadians(-135)))
                .build();

        Trajectory initialIntake2 = drive.trajectoryBuilder(placePurple1.end())
                .addDisplacementMarker(() -> {
                    intakeSA.setPower(0);
                    intakeSB.setPower(0);
                    intakeLinkA.setPosition(0.48);
        ...
        Trajectory placePurple3 = drive.trajectoryBuilder(startPose, true)
                .lineToLinearHeading(new Pose2d(-24, -32, Math.toRadians(-135)))
                .build();

        Trajectory initialIntake3 = drive.trajectoryBuilder(placePurple1.end())
                .addDisplacementMarker(() -> {
                    intakeSA.setPower(0);
                    intakeSB.setPower(0);
                    intakeLinkA.setPosition(0.48);
        ...
        Trajectory park = drive.trajectoryBuilder(scorePose)
                ...
                .forward(5, SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
